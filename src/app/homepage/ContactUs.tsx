          ...
          <Grid container spacing={isSmallScreen ? 2 : 3}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <TextField
                ...
                placeholder={
                  posts[0]?.data.placeholder1 || "Enter your first name"
                }
                variant="outlined"
            ...
            <Grid item xs={12} sm={6}>
              ...
              <TextField
                ...
                onChange={handleChange}
                placeholder={
                  posts[0]?.data.placeholder2 || "Enter your last name"
                }
                variant="outlined"
            ...
            <Grid item xs={12} sm={6}>
              ...
              <TextField
                ...
                onChange={handleChange}
                placeholder={
                  posts[0]?.data.placeholder4 || "Enter your contact number"
                }
                type="tel"
                variant="outlined"
            ...
            <Grid item xs={12}>
              ...
              <TextField
                ...
                onChange={handleChange}
                placeholder={
                  posts[0]?.data.placeholder5 || "Enter your message"
                }
                multiline
                rows={4}
                variant="outlined"
